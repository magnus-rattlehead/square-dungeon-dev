...
public class Weapon extends GameObject {
	...
	public Weapon(int x, int y, ID id, SpriteSheet ss, String name, boolean buyable, int price, int level, int damage,
			int bv, boolean owns, boolean firstInit, boolean startingWeapon, int magSize, int maxAmmo, int w, int h) {
		super(x, y, id, ss);
		this.name = name;
